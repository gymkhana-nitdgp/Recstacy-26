...
const AudioControl = () => {
  ...
  return (
    <button
      ...
      className="fixed top-5 right-5 z-[81] pointer-events-auto group"
    ...
    >
      ...
      */}
      <div className="relative w-10 h-10 md:w-12 md:h-12 flex items-center justify-center 
        ...
        {isPlaying ? (
          <svg className="w-5 h-5 md:w-6 md:h-6 text-[#FFEBD0] drop-shadow-md" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M5.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.337-1.707.707L5.586 15z" />
          </svg>
        ) : (
          <svg className="w-5 h-5 md:w-6 md:h-6 text-white/50 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
