...
const AboutPage: React.FC = () => {
  ...
  return (
    <motion.div
      ref={sectionRef}
      // CHANGE: Removed min-h-screen for mobile to allow content to dictate height
      // CHANGE: Reduced bottom padding (pb-4)
      className="abt-us min-h-[auto] md:min-h-screen bg-[#050505] relative overflow-hidden flex flex-col items-center justify-start mt-0 p-4 pb-4 md:p-8 md:pb-20 selection:bg-[#D4AF37] selection:text-black"
    >
      {!isMobile && (
        <video
          ref={bgVideoRef}
      ...
      <div
        ref={contentRef}
        // CHANGE: Reduced mt-48 to mt-32 on mobile to pull content up
        // CHANGE: Reduced mb-10 to mb-2 on mobile to bring the end of section closer
        className="relative z-[3] w-full max-w-7xl mx-auto flex flex-col items-center scroll-fade-in mt-32 sm:mt-56 lg:mt-64"
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-12 lg:gap-16 w-full mb-2 sm:mb-16 perspective-1000">
